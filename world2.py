...
def windowI():
    ...
    lbl = Label(window9, text="Q.10 Which river is the fastest flowing river in the world?", font=("Arial", 25), background="cyan",
                compound=LEFT).pack()
    R1 = Radiobutton(window9, text="Amazon", font=("Arial", 20), background="White", variable=radio, value="correct choice",
                     command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window9, text="Congo", font=("Arial", 20), background="White", variable=radio, value="incorrect choice",
                     command=selection).pack(anchor=NW)
    R3 = Radiobutton(window9, text="Brahamputra", font=("Arial", 20), background="White", variable=radio,
                     value="wrong choice", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window9, text="Nile", font=("Arial", 20), background="White", variable=radio,
                     value="wrong option", command=selection)
...
def windowG():
    ...
    lbl = Label(window7, text="Q.8 Russia has how many time zones?", font=("Arial", 25), background="cyan",
                compound=LEFT).pack()
    R1 = Radiobutton(window7, text="1", font=("Arial", 20), background="White", variable=radio, value="wrong choice",
                     command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window7, text="11", font=("Arial", 20), background="White", variable=radio, value="correct choice",
                     command=selection).pack(anchor=NW)
    R3 = Radiobutton(window7, text="3", font=("Arial", 20), background="White", variable=radio, value="wrong option",
                     command=selection).pack(anchor=NW)
    R4 = Radiobutton(window7, text="10", font=("Arial", 20), background="White", variable=radio, value="incorrect choice",
                     command=selection).pack(anchor=NW)
...
def windowD():
    ...
    lbl = Label(window4, text="Q.5 Dead sea is located between which two countries?", font=("Arial", 25),
                background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window4, text="Jorden and Israel", font=("Arial", 20), background="White", variable=radio, value="correct choice",
                     command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window4, text="Jorden and Sudan", font=("Arial", 20), background="White", variable=radio, value="wrong choice",
                     command=selection).pack(anchor=NW)
    R3 = Radiobutton(window4, text="Isreal and UAE", font=("Arial", 20), background="White", variable=radio,
                     value="incorrect choice", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window4, text="UAE and Egypt", font=("Arial", 20), background="White", variable=radio,
                     value="wrong option ", command=selection).pack(anchor=NW)
    label = Label(window4)
    label.pack()
...
def windowC():
    ...
    lbl = Label(window3, text="Q.4 Which is the largest ocean in world?",
                font=("Arial", 25), background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window3, text="Atlantic Ocean", font=("Arial", 20), background="White", variable=radio, value="incorrect choice",
                     command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window3, text="Pacific Ocean", font=("Arial", 20), background="White", variable=radio, value="correct choice",
                     command=selection).pack(anchor=NW)
    R3 = Radiobutton(window3, text="Indian Ocean", font=("Arial", 20), background="White", variable=radio, value="wrong choice",
                     command=selection).pack(anchor=NW)
    R4 = Radiobutton(window3, text="Arctic Ocean", font=("Arial", 20), background="White", variable=radio, value=" wrong answer",
                     command=selection).pack(anchor=NW)
...
def windowB():
    ...
    lbl = Label(window2, text="Q.3 Which city in India is know as 'Scotland of India'?", font=("Arial", 25),
                background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window2, text="Coorg", font=("Arial", 20), background="White", variable=radio,
                     value="Correct choice", command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window2, text="Darjelling", font=("Arial", 20), background="White", variable=radio,
                     value="wrong choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window2, text="Mumbai", font=("Arial", 20), background="White", variable=radio,
                     value="wrong option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window2, text="Assam", font=("Arial", 20), background="White", variable=radio,
                     value="incorrect choice", command=selection).pack(anchor=NW)
...
def Questions():
    ...
    lbl = Label(window, text="Q.1 Which continent is refered as country?", font=("Arial", 25), background="cyan",
                compound=LEFT).pack()
    R1 = Radiobutton(window, text="Australia", font=("Arial", 20), background="White", variable=radio, value="correct choice",
                     command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window, text="Africa", font=("Arial", 20), background="White", variable=radio, value="wrong choice",
                     command=selection).pack(anchor=NW)
    R3 = Radiobutton(window, text="Asia", font=("Arial", 20), background="White", variable=radio, value="incorrect choice",
                     command=selection).pack(anchor=NW)
    R4 = Radiobutton(window, text="Europe", font=("Arial", 20), background="White", variable=radio, value="wrong option",
                     command=selection).pack(anchor=NW)
    label = Label(window)
    label.pack()
