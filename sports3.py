...
def windowI():
    ...
    R1=Radiobutton(window9, text="Gymnastics", font=("Arial",20),background="White",
                         variable=radio, value="Wrong choice", command=selection).pack(anchor=NW)
    R2 =Radiobutton(window9, text="Boxing", font=("Arial", 20),background="White",
    ...
    R4 =Radiobutton(window9, text="Ice hockey", font=("Arial", 20),background="White",
...
def windowH():
    ...
    R1 = Radiobutton(window8, text=2017, font=("Arial",20),background="white",
                     variable=radio, value="correct optio", command=selection).pack(anchor=NW)
    R2 = Radiobutton(window8, text=2005, font=("Arial",20),background="white",
                     variable=radio, value="wrong option", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window8, text=2010, font=("Arial",20),background="white",
                     variable=radio, value="incorrect choice", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window8, text=2016, font=("Arial",20),background="white",
                     variable=radio, value="wrong choice", command=selection).pack(anchor=NW)
...
def windowG():
    ...
    variable=radio,value="correct option",command=selection).pack(anchor=NW)
    R2=Radiobutton(window7,text="Vishwanathan anand",font=("Arial",20),background="White",
    variable=radio,value="wrong choice",command=selection).pack(anchor=NW)
    R3=Radiobutton(window7,text="vladimir kramnink",font=("Arial",20),background="White",
    variable=radio,value="incorrect choice",command=selection).pack(anchor=NW)
    R4=Radiobutton(window7,text="Garry Kasparov",font=("Arial",20),background="White",
    variable=radio,value="wrong option",command=selection).pack(anchor=NW)
...
def windowF():
    ...
    R1 = Radiobutton(window6, text="England", font=("Arial", 20), background="White",
                     variable=radio, value="wrong choice", command=selection).pack(anchor=NW)
    R2 = Radiobutton(window6, text="Newzealand", font=("Arial",20), background="White",
                     variable=radio, value="correct option", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window6, text="India", font=("Arial",20), background="White",
                     variable=radio, value="wrong option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window6, text="Australia", font=("Arial",20), background="White",
                     variable=radio, value="incorrect choice", command=selection).pack(anchor=NW)
...
def windowE():
    ...
    R1=Radiobutton(window5,text="Delhi",font=("Arial",20),background="White",
    variable=radio,value="Wrong choice",command=selection).pack(anchor=NW)
    R2=Radiobutton(window5,text="Himachal Pradesh",font=("Arial",20),background="White",
    variable=radio,value="wrong option",command=selection).pack(anchor=NW)
    R3=Radiobutton(window5,text="Karnataka",font=("Arial",20),background="White",
    variable=radio,value="correct option",command=selection).pack(anchor=NW)
    R4=Radiobutton(window5,text="Maharashta",font=("Arial",20),background="White",
    variable=radio,value="incorrect choice",command=selection).pack(anchor=NW)
...
def windowD():
    ...
    variable=radio,value="correct option",command=selection).pack(anchor=NW)
    R2=Radiobutton(window4,text="Yuvraj Singh",font=("Arial",20),background="White",
    variable=radio,value="wrong choice",command=selection).pack(anchor=NW)
    R3=Radiobutton(window4,text="Kireon Pollard",font=("Arial",20),background="White",
    variable=radio,value="wrong option",command=selection).pack(anchor=NW)
    R4=Radiobutton(window4,text="Stuard Broad",font=("Arial",20),background="White",
    variable=radio,value="incorrect choice",command=selection).pack(anchor=NW)
...
def windowC():
    ...
    R1=Radiobutton(window3,text="Kamaljeet Sandhu",font=("Arial",20),background="White",
    variable=radio,value="wrong option",command=selection).pack(anchor=NW)
    R2=Radiobutton(window3,text="Bahadur singh Chauhan",font=("Arial",20),background="White",
    variable=radio,value="wrong choice",command=selection).pack(anchor=NW)
    R3=Radiobutton(window3,text="Milkha singh",font=("Arial",20),background="White",
    variable=radio,value="correct option",command=selection).pack(anchor=NW)
    R4=Radiobutton(window3,text="Harmanpreet Singh",font=("Arial",20),background="White",
    variable=radio,value="incorrect choice",command=selection).pack(anchor=NW)
...
def windowB():
    ...
    R1=Radiobutton(window2,text="Manchester United",font=("Arial",20),background="White",
    variable=radio,value="wrong choice",command=selection).pack(anchor=NW)
    R2=Radiobutton(window2,text="Liverpool",font=("Arial",20),background="White",
    variable=radio,value="wrong option",command=selection).pack(anchor=NW)
    R3=Radiobutton(window2,text="Real Madrid",font=("Arial",20),background="White",
    variable=radio,value="correct option",command=selection).pack(anchor=NW)
    R4=Radiobutton(window2,text="Montevideo Wanderers",font=("Arial",20),background="White",
    variable=radio,value="incorrect choice",command=selection).pack(anchor=NW)
...
def windowA():
    ...
    R1=Radiobutton(window1,text="Colombia",font=("Arial",20),background="White",
    variable=radio,value="wrong choice",command=selection).pack(anchor=NW)
    R2=Radiobutton(window1,text="Scotland",font=("Arial",20),background="White",
    variable=radio,value="wrong option",command=selection).pack(anchor=NW)
    R3=Radiobutton(window1,text="Japan and Korea",font=("Arial",20),background="White",
    variable=radio,value="correct option",command=selection).pack(anchor=NW)
    R4=Radiobutton(window1,text="Germany",font=("Arial",20),background="White",
    variable=radio,value="incorrect choice",command=selection).pack(anchor=NW)
...
def Questions():
    ...
    lbl1=Label(window,text="Q.1 Which cricket Batsman has the highest rating in T20 cricket?",
    font=("Arial",25),background="cyan",compound=LEFT).pack()

    R1=Radiobutton(window,text="David Malan",font=("Arial",20),background="White",
    variable=radio,value="correct option",command=selection).pack(anchor=NW)
    R2=Radiobutton(window,text="Babar Azam",font=("Arial",20),background="White",
    variable=radio,value="wrong choice",command=selection).pack(anchor=NW)
    R3=Radiobutton(window,text="Virat Kohli",font=("Arial",20),background="White",
    variable=radio,value="wrong option",command=selection).pack(anchor=NW)
    R4=Radiobutton(window,text="Sachin Tendulkar",font=("Arial",20),background="White",
    variable=radio,value="incorrect choice",command=selection).pack(anchor=NW)
