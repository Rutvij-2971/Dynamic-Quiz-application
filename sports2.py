...
def windowI():
    ...
    lbl1 = Label(window9, text="Q.10 Where were the 2002 worldcup fnals held?" , font=("Arial",25),background="cyan", compound=LEFT).pack()

    R1=Radiobutton(window9, text="Germany", font=("Arial",20),background="White",
                         variable=radio, value="Wrong choice", command=selection).pack(anchor=NW)
    R2 =Radiobutton(window9, text="Colombia", font=("Arial", 20),background="White",
                         variable=radio, value="wrong option", command=selection).pack(anchor=NW)
    R3 =Radiobutton(window9, text="Scotland", font=("Arial", 20),background="White",
                         variable=radio, value="incorrect choice", command=selection).pack(anchor=NW)
    R4 =Radiobutton(window9, text="Japan and Korea", font=("Arial", 20),background="White",
...
def windowH():
    ...
    lbl1 = Label(window8, text="Q.9 Which football club does David Beckham play for?",
                 font=("Arial", 25), background="cyan", compound=LEFT).pack()

    R1 = Radiobutton(window8, text="Manchester united", font=("Arial", 20), background="White",
                     variable=radio, value="wrong choice", command=selection).pack(anchor=NW)
    R2 = Radiobutton(window8, text="Liverpool", font=("Arial", 20), background="White",
                     variable=radio, value="wrong option", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window8, text="Real Madrid", font=("Arial", 20), background="White",
                     variable=radio, value="correct option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window8, text="Montevideo Wanderers", font=("Arial", 20), background="White",
                     variable=radio, value="incorrect choice", command=selection).pack(anchor=NW)
    label = Label(window8)
    label.pack()
...
def windowE():
    ...
    lbl1 = Label(window5, text="Q.5 Which player is given the title of the flying sikh?",
                 font=("Arial", 25), background="cyan", compound=LEFT).pack()

    R1 = Radiobutton(window5, text="Milkha Singh", font=("Arial", 20), background="White",
                     variable=radio, value="correct option", command=selection).pack(anchor=NW)
    R2 = Radiobutton(window5, text="Bahadur Singh Chauhan", font=("Arial", 20), background="White",
                     variable=radio, value="wrong choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window5, text="Kamaljeet Sandhu", font=("Arial", 20), background="White",
                     variable=radio, value="wrong option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window5, text="Harmanpreet singh", font=("Arial", 20), background="White",
                     variable=radio, value="incorrect choice", command=selection).pack(anchor=NW)
...
def windowD():
    ...
    lbl1 = Label(window4,text="Q.5 Which cricket team won the semifinals but lost in the finals of the world cup 2019?",
                 font=("Arial", 25), background="cyan", compound=LEFT).pack()

    R1 = Radiobutton(window4, text="India", font=("Arial", 20), background="White",
                     variable=radio, value="Wrong choice", command=selection).pack(anchor=NW)
    R2 = Radiobutton(window4, text="Australia", font=("Arial", 20), background="White",
                     variable=radio, value="wrong option", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window4, text="Newzealand", font=("Arial", 20), background="White",
                     variable=radio, value="correct option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window4, text="England", font=("Arial", 20), background="White",
                     variable=radio, value="incorrect choice", command=selection).pack(anchor=NW)
...
def windowA():
    ...
    background="White").pack()
    lbl1 = Label(window1, text="Q2.Which sport does not use the term ring?", font=("Arial", 25), background="cyan",
                 compound=LEFT).pack()

    R1 = Radiobutton(window1, text="Boxing", font=("Arial", 20), background="white",
                     variable=radio, value="Wrong choice", command=selection).pack(anchor=NW)
    R2 = Radiobutton(window1, text="Gymnastics", font=("Arial", 20), background="white",
                     variable=radio, value="wrong option", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window1, text="Icehockey", font=("Arial", 20), background="white",
                     variable=radio, value="incorrect choice", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window1, text="Baseball", font=("Arial", 20), background="white",
                     variable=radio, value="correct option", command=selection).pack(anchor=NW)
...
def Questions():
    ...
    lbl1=Label(window,text="Q.1 Which chess player has the highest rating in chess ",
    font=("Arial",25),background="cyan",compound=LEFT).pack()

    R1=Radiobutton(window,text="Magnus Carlsen",font=("Arial",20),background="White",
    variable=radio,value="correct option",command=selection).pack(anchor=NW)
    R2=Radiobutton(window,text="Garry Kasparov",font=("Arial",20),background="White",
    variable=radio,value="wrong choice",command=selection).pack(anchor=NW)
    R3=Radiobutton(window,text="Vishwanathan Anand",font=("Arial",20),background="White",
    variable=radio,value="wrong option",command=selection).pack(anchor=NW)
    R4=Radiobutton(window,text="Vladimir Kramnink",font=("Arial",20),background="White",
    variable=radio,value="incorrect choice",command=selection).pack(anchor=NW)
