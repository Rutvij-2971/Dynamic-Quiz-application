...
def windowI():
    ...
    R1 = Radiobutton(window9, text="Snake", font=("Arial", 20), background="White", variable=radio, value="incorrect choice",
                     command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window9, text="Fish", font=("Arial", 20), background="White", variable=radio, value="correct choice",
                     command=selection).pack(anchor=NW)
    R3 = Radiobutton(window9, text="Crocodile", font=("Arial", 20), background="White", variable=radio, value="wrong choice",
                     command=selection).pack(anchor=NW)
    R4 = Radiobutton(window9, text="Lizard", font=("Arial", 20), background="White", variable=radio, value=" wrong answer",
                     command=selection).pack(anchor=NW)
    label = Label(window9)
    label.pack()
...
def windowG():
    ...
    lbl = Label(window7, text="Q.8 What is the life span of the RBC?", font=("Arial", 25),
                background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window7, text="115 days", font=("Arial", 20), background="White", variable=radio,
                     value="Correct choice", command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window7, text="110 days", font=("Arial", 20), background="White", variable=radio,
                     value="wrong choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window7, text="100 days", font=("Arial", 20), background="White", variable=radio,
                     value="wrong option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window7, text="120 days", font=("Arial", 20), background="White", variable=radio,
                     value="incorrect choice", command=selection).pack(anchor=NW)
    label = Label(window7)
    label.pack()
...
def windowE():
    ...
    R1 = Radiobutton(window5, text="24", font=("Arial", 20), background="White", variable=radio, value="correct choice",
                     command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window5, text="23", font=("Arial", 20), background="White", variable=radio, value="wrong choice",
                     command=selection).pack(anchor=NW)
    R3 = Radiobutton(window5, text="25", font=("Arial", 20), background="White", variable=radio,
                     value="wrong option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window5, text="34", font=("Arial", 20), background="White", variable=radio,
                     value="incorrect choice", command=selection).pack(anchor=NW)
    label = Label(window5)
    label.pack()
...
def windowD():
    ...
    lbl = Label(window4, text="Q.5 What is the smallest flightless bird ?", font=("Arial", 25),
                background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window4, text="Rhea", font=("Arial", 20), background="White", variable=radio, value="correct choice",
                     command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window4, text="Kiwi", font=("Arial", 20), background="White", variable=radio, value="wrong choice",
                     command=selection).pack(anchor=NW)
    R3 = Radiobutton(window4, text="Penguin", font=("Arial", 20), background="White", variable=radio,
                     value="incorrect choice", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window4, text="Ostrich", font=("Arial", 20), background="White", variable=radio,
                     value="wrong option ", command=selection).pack(anchor=NW)
    label = Label(window4)
    label.pack()
...
def windowC():
    ...
    lbl = Label(window3, text="Q.4 The process of preparing food in plants is called as ?", font=("Arial", 25), background="cyan",
                compound=LEFT).pack()
    R1 = Radiobutton(window3, text="Photosynthesis", font=("Arial", 20), background="White", variable=radio, value="correct choice",
                     command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window3, text="Transpiration ", font=("Arial", 20), background="White", variable=radio, value="incorrect choice",
                     command=selection).pack(anchor=NW)
    R3 = Radiobutton(window3, text="Translocation", font=("Arial", 20), background="White", variable=radio,
                     value="wrong choice", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window3, text="Respiration", font=("Arial", 20), background="White", variable=radio,
                     value="wrong option", command=selection).pack(anchor=NW)
    label = Label(window3)
    label.pack()
...
def windowB():
    ...
    lbl = Label(window2, text="Q.3 Newton is the unit of ?", font=("Arial", 25), background="cyan",
                compound=LEFT).pack()
    R1 = Radiobutton(window2, text="Distance", font=("Arial", 20), background="White", variable=radio, value="wrong choice",
                     command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window2, text="Force", font=("Arial", 20), background="White", variable=radio, value="correct choice",
                     command=selection).pack(anchor=NW)
    R3 = Radiobutton(window2, text="Displacement", font=("Arial", 20), background="White", variable=radio, value="wrong option",
                     command=selection).pack(anchor=NW)
    R4 = Radiobutton(window2, text="Energy", font=("Arial", 20), background="White", variable=radio, value="incorrect choice",
                     command=selection).pack(anchor=NW)
    label = Label(window2)
    label.pack()
...
def windowA():
    ...
    lbl = Label(window1, text="Q.2 Depth of the ocean is measured by the instrument called ", font=("Arial", 25),
                background="cyan", compound=LEFT).pack()
    R1 = Radiobutton(window1, text="Monometer", font=("Arial", 20), background="White", variable=radio,
                     value="incorrect option", command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window1, text="Fathometer", font=("Arial", 20), background="White", variable=radio,
                     value="correct choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window1, text="Lectometer", font=("Arial", 20), background="White", variable=radio,
                     value="wrong choice", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window1, text="Photometer", font=("Arial", 20), background="White", variable=radio,
                     value="incorrect choice", command=selection).pack(anchor=NW)
    label = Label(window1)
    label.pack()
...
def Questions():
    ...
    lbl = Label(window, text="Q.1 The fuel capacity of the Mars mission which was launched in India was?", font=("Arial", 25), background="cyan",
                compound=LEFT).pack()
    R1 = Radiobutton(window, text="850kg", font=("Arial", 20), background="White", variable=radio, value="correct choice",
                     command=selection).pack(anchor=NW)
    # creates radiobuttons as to be chosenby the user....only one at a time
    R2 = Radiobutton(window, text="405kg", font=("Arial", 20), background="White", variable=radio, value="wrong choice",
                     command=selection).pack(anchor=NW)
    R3 = Radiobutton(window, text="800kg", font=("Arial", 20), background="White", variable=radio, value="incorrect choice",
                     command=selection).pack(anchor=NW)
    R4 = Radiobutton(window, text="600kg", font=("Arial", 20), background="White", variable=radio, value="wrong option",
                     command=selection).pack(anchor=NW)
    label = Label(window)
    label.pack()
