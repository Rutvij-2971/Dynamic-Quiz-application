...
def windowI():
    ...
    R1 = Radiobutton(window9, text="Mexico", font=("Arial", 20), background="white", variable=radio,
                     value="wrong choice", command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window9, text="Brazil", font=("Arial", 20), background="white", variable=radio,
                     value="correct choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window9, text="Hawaii", font=("Arial", 20), background="white", variable=radio,
                     value="wrong option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window9, text="India", font=("Arial", 20), background="white", variable=radio,
...
def windowH():
    ...
    R1 = Radiobutton(window8, text="papayas, broccoli, tomatoes, kale", font=("Arial", 20), background="white",
    ...
    R3 = Radiobutton(window8, text="Sugar, Sugar cane", font=("Arial", 20), background="white", variable=radio,
                     value="wrong option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window8, text="tomatoes, brinjal, potatoes", font=("Arial", 20), background="white",
...
def windowG():
    ...
    R1 = Radiobutton(window7, text="Canada", font=("Arial", 20), background="white", variable=radio,
                     value="wrong choice", command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window7, text="Mexico", font=("Arial", 20), background="white", variable=radio,
                     value="correct choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window7, text="Italy", font=("Arial", 20), background="white", variable=radio,
                     value="wrong option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window7, text="India", font=("Arial", 20), background="white", variable=radio,
                     value="incorrect choice", command=selection).pack(anchor=NW)
...
def windowF():
    ...
    R1 = Radiobutton(window6, text="USA", font=("Arial", 20), background="white", variable=radio, value="wrong choice",
                     command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window6, text="India", font=("Arial", 20), background="white", variable=radio,
                     value="correct choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window6, text="China", font=("Arial", 20), background="white", variable=radio,
                     value="wrong option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window6, text="Korea", font=("Arial", 20), background="white", variable=radio,
                     value="incorrect choice", command=selection).pack(anchor=NW)
...
def windowD():
    ...
    R1 = Radiobutton(window4, text="Jammu and Kashmir", font=("Arial", 20), background="white", variable=radio,
                     value="wrong choice", command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window4, text="Himachal Pradesh", font=("Arial", 20), background="white", variable=radio,
                     value="correct choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window4, text="Uttar Pradesh", font=("Arial", 20), background="white", variable=radio,
                     value="wrong option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window4, text=" Punjab", font=("Arial", 20), background="white", variable=radio,
                     value="incorrect choice", command=selection).pack(anchor=NW)
...
def windowC():
    ...
    R1 = Radiobutton(window3, text="Dal", font=("Arial", 20), background="white", variable=radio,
                     value="wrong choice", command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window3, text="Khichdi", font=("Arial", 20), background="white", variable=radio,
                     value="correct choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window3, text="Roti", font=("Arial", 20), background="white", variable=radio,
                     value="wrong option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window3, text="Dosa", font=("Arial", 20), background="white", variable=radio,
                     value="incorrect choice", command=selection).pack(anchor=NW)
...
def windowB():
    ...
    R1 = Radiobutton(window2, text="Europe", font=("Arial", 20), background="white", variable=radio,
                     value="wrong choice", command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window2, text="South East Asia", font=("Arial", 20), background="white", variable=radio,
                     value="correct choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window2, text="Mexico", font=("Arial", 20), background="white", variable=radio,
                     value="wrong option", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window2, text="Italy", font=("Arial", 20), background="white", variable=radio,
                     value="incorrect choice", command=selection).pack(anchor=NW)
...
def Questions():
    ...
    lbl1 = Label(window, text="Q.1 Where does coffee originate from?", font=("Arial", 25), background="cyan",
                 compound=LEFT).pack()

    R1 = Radiobutton(window, text="korea", font=("Arial", 20), background="white", variable=radio, value="wrong choice",
                     command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window, text="Ethiopia", font=("Arial", 20), background="white", variable=radio,
                     value="correct choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window, text="China", font=("Arial", 20), background="white", variable=radio, value="wrong option",
                     command=selection).pack(anchor=NW)
    R4 = Radiobutton(window, text="Denmark", font=("Arial", 20), background="white", variable=radio,
                     value="incorrect choice", command=selection).pack(anchor=NW)
