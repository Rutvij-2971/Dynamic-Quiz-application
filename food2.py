...
def windowI():
    ...
    lbl1 = Label(window9, text="Q.10 Which country is known fo mangoes?", font=("Arial", 25),
                 background="cyan", compound=LEFT).pack()

    R1 = Radiobutton(window9, text="USA", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window9, text="India", font=("Arial", 20), background="white", variable=radio,
                     value=" choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window9, text="China", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window9, text=" Korea", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(anchor=NW)
...
def windowH():
    ...
    def selection():
        global score
        selected = "you have selected option,proceed to next"
        label.config(text=selected)
        if str(radio.get()) == " choice":
            score += 10
            print(score)
        else:
            score += 0
    ...
    lbl1 = Label(window8, text="Q.9 Strawberry is good source of which vitamin?", font=("Arial", 25), background="cyan",
                 compound=LEFT).pack()

    R1 = Radiobutton(window8, text="Vitamin A", font=("Arial", 20), background="white", variable=radio, value="a choice",
                     command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window8, text="Vitamin C", font=("Arial", 20), background="white", variable=radio,
                     value=" choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window8, text="Vitamin D", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window8, text="Vitanin B", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(anchor=NW)
...
def windowG():
    ...
    lbl1 = Label(window7, text="Q.8 Common food sources of Vitamin A are", font=("Arial", 25), background="cyan",
                 compound=LEFT).pack()

    R1 = Radiobutton(window7, text="papaya", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window7, text="milk,egg", font=("Arial", 20), background="white", variable=radio,
                     value=" choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window7, text="Beans", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window7, text="carrots", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(anchor=NW)
...
def windowF():
    ...
    lbl1 = Label(window6, text="Q.7 Which state is known as the apple state of India?", font=("Arial", 25), background="cyan",
                 compound=LEFT).pack()

    R1 = Radiobutton(window6, text="Karnataka", font=("Arial", 20), background="white",
                     variable=radio, value="a choice", command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window6, text="Himachal Pradesh", font=("Arial", 20), background="white",
                     variable=radio, value=" choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window6, text="Bihar", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window6, text="Uttar pradesh", font=("Arial", 20), background="white",
                     variable=radio, value="a choice", command=selection).pack(anchor=NW)
...
def windowD():
    ...
    lbl1 = Label(window4, text="Q.5 Where did the Ceasar salad originate from?", font=("Arial", 25), background="cyan",
                 compound=LEFT).pack()

    R1 = Radiobutton(window4, text="Canada", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window4, text="Mexico", font=("Arial", 20), background="white", variable=radio,
                     value=" choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window4, text="Italy", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(anchor=NW)
...
def windowC():
    ...
    R1 = Radiobutton(window3, text="Roti", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window3, text="Khichdi", font=("Arial", 20), background="white", variable=radio,
                     value=" choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window3, text="Dosa", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window3, text="Upma", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(anchor=NW)
...
def windowB():
    ...
    lbl1 = Label(window2, text="Q.3 Where does the coffee originate from", font=("Arial", 25),
                 background="cyan", compound=LEFT).pack()

    R1 = Radiobutton(window2, text="Canada", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window2, text="Ethiopia", font=("Arial", 20), background="white", variable=radio,
                     value=" choice", command=selection).pack(anchor=NW)
...
def windowA():
    ...
    lbl1 = Label(window1, text="Q.2 Where are bananas originally from?", font=("Arial", 25),
                 background="cyan", compound=LEFT).pack()

    R1 = Radiobutton(window1, text="China", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window1, text="South East Asia", font=("Arial", 20), background="white", variable=radio,
                     value=" choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window1, text="USA", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(anchor=NW)
    R4 = Radiobutton(window1, text="Pakistan", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(anchor=NW)
...
def Questions():
    ...
    lbl1 = Label(window, text="Q.1 Where did the pineapple originate from?", font=("Arial", 25), background="cyan",
                 compound=LEFT).pack()

    R1 = Radiobutton(window, text="India", font=("Arial", 20), background="white", variable=radio, value="a choice",
                     command=selection).pack(
        anchor=NW)  # creates radiobuttons as to be chosen by the user....only one at a time
    R2 = Radiobutton(window, text="Brazil", font=("Arial", 20), background="white", variable=radio,
                     value=" choice", command=selection).pack(anchor=NW)
    R3 = Radiobutton(window, text="Denmark", font=("Arial", 20), background="white", variable=radio, value="a choice",
                     command=selection).pack(anchor=NW)
    R4 = Radiobutton(window, text="China", font=("Arial", 20), background="white", variable=radio,
                     value="a choice", command=selection).pack(anchor=NW)
